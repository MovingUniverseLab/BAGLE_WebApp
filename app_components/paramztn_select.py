...
class ParamztnSelect(Viewer):
    ...
    def __init__(self, **params):
        ...
        self.paramztn_error = pn.pane.HTML(
            object = f'''
                <div style="font-size:{constants.FONTSIZES['paramztn_error']};font-family:{constants.HTML_FONTFAMILY}">
            ...
            ''',
            styles = {'color':'red', 'margin-bottom': '0', 'text-align':'center', 'width':'100%'}
        )
