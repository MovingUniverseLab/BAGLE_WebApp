...
class ModSelect(Viewer):
    ...
    def __init__(self, **params):
        ...
        self.srclens_type = pn.widgets.Select(
            name = '', 
            ...
            stylesheets = [styles.DROPDOWN_STYLESHEET]
        )

        self.data_type = pn.widgets.Select(
            name = '', 
        ...
        self.par_type = pn.widgets.Select(
            name = '', 
        ...
        self.gp_type = pn.widgets.Select(
            name = '', 
    ...
    def _make_layout(self):
        ...
        for i in insert_idx:
            plus = pn.widgets.StaticText(
                name = '', 
                value = '+', 
                align = 'center',
                styles = {'font-size':styles.FONTSIZES['plus']}
            )
